...
export const baseApi = createApi({
    ...
    tagTypes: ['Travelling', 'Utility', 'Employee', 'loan', 'Miscellaneous', 'Collection', 'Buyer Development', 'Factory', 'User', "Loan", "fixedCost", "production", "targetOutput", "report", "notification", "order", "Output", "ProductionCost"],
    endpoints: () => ({}),
});